document.addEventListener("DOMContentLoaded", function () {
  ...
  window.CHL_UPDATED = "2026-06-23";

  const CONVENTIONAL_RATE = "6.375%";
  const CONVENTIONAL_APR = "6.40%";
  ...
  const DISCLAIMER =
    "*Today's mortgage rates based on the average home purchase price of $585,000 and 760 credit score. 30yr fixed rates at 80% LTV for Conventional Loan, 96.5% LTV for FHA Loan, and 100% LTV for VA loan.";
