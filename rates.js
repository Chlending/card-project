...
const CONVENTIONAL_RATE='6.369%'
const CONVENTIONAL_APR="6.4%"

const FHA_RATE="6.205%"
const FHA_APR="7.08%"

const VA_RATE="6.125%"
const VA_APR="6.35%"

const DISCLAIMER = "*As of 10/29/2024. Rates based on the average purchase price of $525,000 and 740 credit score. 30yr fixed rates at 80% LTV for Conventional Loan - affordable loan program, 96.5% LTV for FHA Loan, and 100% LTV for VA loan."
